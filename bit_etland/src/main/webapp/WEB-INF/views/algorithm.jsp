...
<!--
	...
	@Date: 2019. 3. 18. 오전 10:38:00
	@File Name: algorithm.jsp
	@Desc: 
 -->
<!DOCTYPE html>
<html lang="en">
...
<div class="container-fluid">
  <div class="row content">
    ...
    <div class="col-sm-9">
      ...
      <h5><span id="answer_btn_1" class="label label-danger">Food</span> <span id="reset" class="label label-primary">Ipsum</span></h5><br>
      ...
      <div class="row">
        <div class="col-sm-2 text-center">
          <img src="https://www.w3schools.com/bootstrap/bandmember.jpg" class="img-circle" height="65" width="65" alt="Avatar">
        </div>
        <div class="col-sm-10">
